package academy.bangkit.brewtopia.custom_view
...
class NameInput : AppCompatEditText, View.OnTouchListener{
    ...
    private fun showIconPeople() {
        setDrawable(start = userIconImage)
    }
